...
public class CourseService {
    ...
    public CoursePublishResult preview(String courseId) {
        ...
        //3、返回CoursePublishResult对象（当中包含了页面预览的url）
    ...
    public CoursePublishResult publish(String id) {
        ...
        //将coursePub对象保存到数据库
        CoursePub coursePubSave = saveCoursePub(id, coursePub);
        //缓存课程的信息
        //...
        //得到页面的url
...
//            teachplanMediaPubRepository.save(teachplanMediaPub);
        ...
        //3将teachplanMediaList插入到teachplanMediaPub
    ...
    private CoursePub saveCoursePub(String id, CoursePub coursePub) {
        ...
        CoursePub coursePubOne = coursePubRepository.save(coursePubNew);
        return coursePubNew;
    }
